...
import CreateTranport from "../Admin/CreateTranport";
import Booking from "../Admin/Booking";
import BookingData from "../Admin/BookingData";
import Verify from "../Admin/Verify";
import UserProfiile from "../Admin/UserProfiile";
...
function Smdrawer(props) {
  ...
  const [mobileOpen, setMobileOpen] = React.useState(false);
    const [menuLinks,SetMenulinks] = React.useState([
      ...
      {
        displayName: "New Transport",
            routeName:   "createTranport",
        },
      {
        displayName: "Verify",
            routeName:   "verify",
      ...
      >
        ...
        {/* Routing */}
         <Routes>
          ...
          <Route path="createTranport" element={<CreateTranport />} />
          <Route path="bookingData" element={<BookingData />} />
          <Route path="verify" element={<Verify />} />
          <Route path="userProfile" element={<UserProfiile />} />
          </Routes> 
      </Box>
    </Box>
  );
